...
## 2026-07-25 | 🧪 AIシグナル研究日誌 #050 — 上昇×逆張り買い FWD後半失速 【ゲート実行中】

- **基準日**: 2026-07-25 (JST)
- **優先度**: ②（前向きトラッカー大変動：trend=上昇×reversalL FWD N=113 E(R)=+0.177 CI[-0.01~+0.36]、CI下限がゼロ割れ）
- **下書きファイル**: `drafts/draft-signal-lab-050.html`
...
## 2026-07-24 | 🧪 AIシグナル研究日誌 #049 — 上昇×revL シグナル二極化 【ゲート実行中】

- **基準日**: 2026-07-24 (JST)
- **優先度**: ②（tracker昇格済み「trend=上昇×reversalL」の内部構造分解）
- **下書きファイル**: `drafts/draft-signal-lab-049.html`
