...
<header>
  <div class="header-inner">
    ...
    <div class="header-meta">日本人投資家のためのマーケット情報サイト</div><div style="margin-top:11px;padding-top:11px;border-top:1px solid rgba(128,128,128,.22)"><div style="font-size:1.3rem;font-weight:700;color:#1E3A6E">🧪 シグナル研究</div></div>
  </div>
</header>
<main>
  <nav class="nav-bar">
    ...
    <a class="nav-btn current" href="track-record.html">🧪 シグナル研究</a>
  ...
  <div style="background:#ffebe9;border:2px solid #cf222e;border-left:6px solid #cf222e;border-radius:10px;padding:18px 22px;margin:18px 0;font-size:.93rem;color:#1f2328;line-height:1.75">
    ...
    <ul style="margin:6px 0 6px 22px;padding:0">
      ...
      <li>本ページの「⭐⭐⭐ HIGH」等の表現は過去統計に基づく分類であり、<b>特定銘柄・時間帯への投資勧誘ではありません</b>。</li>
