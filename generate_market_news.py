...
<main>
  ...
  <div style="background:#f6f8fa;border:1px solid #d0d7de;border-left:4px solid #0969da;border-radius:8px;padding:14px 22px;margin-bottom:32px;font-size:.88rem;line-height:1.9">
    ...
    <div style="color:#424a53">
      ...
      ・<b>2026-05-23</b>: 🚗 解説「<a href="guide-toyota-2026-05.html" style="color:#0969da"><b>トヨタ自動車（7203）徹底解説：売上 50 兆円超で日本企業初の偉業 — しかし営業益 -21.5% の「増収減益」を読む</b></a>」公開<br>
      ・<b>2026-05-23</b>: 📅 週次レポート「<a href="guide-weekly-review-2026-05-16.html" style="color:#0969da"><b>週次振り返り（5/16〜5/22）：先週のシグナル全件と教訓 — 勝率 62.5%、信頼度別検証</b></a>」公開<br>
      ...
      ・<b>2026-05-19</b>: 🚨 緊急速報「<a href="guide-btc-crash-2026-05-19.html" style="color:#cf222e"><b>BTC一時$76K割れ速報：イラン情勢でリスクオフ三重苦、$72K/$65K下値メドと日本人投資家3つの示唆</b></a>」公開
    </div>
  </div>
