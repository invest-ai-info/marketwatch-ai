...
<main>
  ...
  <div style="background:#f6f8fa;border:1px solid #d0d7de;border-left:4px solid #0969da;border-radius:8px;padding:14px 22px;margin-bottom:32px;font-size:.88rem;line-height:1.9">
    ...
    <div style="color:#424a53">
      ...
      ・<b>2026-05-11</b>: 📰 プレビュー「<a href="guide-us-cpi-2026-05.html" style="color:#0969da"><b>米CPI5月14日プレビュー：3シナリオ・ドル円/株式インパクトを図解分析</b></a>」公開<br>
      ...
      ・<b>2026-05-06</b>: 🚨 緊急速報「<a href="guide-jpy-intervention-2026-05-06.html" style="color:#cf222e"><b>ドル円155円台に急落・追加介入観測：GW中の連続介入か投機筋の巻き戻しか</b></a>」公開
    </div>
  </div>
