...
def build_html(data, hist, now_jst, news=None, touraku=None):
  ...
  <div class="top-news">
    ...
    _history_items = [
        {"date": "2026-06-13", "line": '・<b>2026-06-13</b>: 🧪 解説「<a href="guide-signal-lab-005.html" style="color:#0969da"><b>研究日誌 #5 「壁あり」シグナルがなぜか強い——veto_runway_blocked の逆転現象を解明する</b></a>」公開'},
