...
>
> 🔴 **オーナー判断待ち＝`hypothesis_queue.md` 45.1KB（予算36KB）の予算改定**。閉じたQは退避済みで、残る Q10/Q24/Q27（計8.1KB）を
> 全部退避しても37.0KBで届かず、しかもその3本は判断待ち/現・次候補＝退避が不適切。実測と根拠＝`_q45_design.md` §6。
...
| 10 | **Q24 の前向き tracker 登録**（変種9本 or 主張1本／チェックポイントN。BTログに news 次元の保有が無く前向きのみ可＝7/31 (e)） | **オーナー判断待ち** |
