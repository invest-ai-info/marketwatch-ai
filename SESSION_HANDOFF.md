...
- **⓪-🔴在flight＝ナビ文言「📈 50年チャート」→「📈 150年チャート」一括更新（オーナー承認済み・7/25 07:16に着手直後セッション移動＝未着手のまま引き継ぎ）**。調査だけ完了、**編集は1件もしていない**。
...
- **⓪-🔜期限到来の確認2件（7/25朝）**: ①**#050（今朝06:10のsignal-lab-daily）に「チャート風図解」が入ったか**＝7/24夜のroutineプロンプト改定の初適用回。入っていなければプロンプトの手本参照（anatomy図1・図2）が効いていない＝要調整 ②`drafts/REVIEW.md` の🚩エスカレ有無。
