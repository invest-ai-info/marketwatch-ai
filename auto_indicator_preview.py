...
<head>
  ...
  <style>
    *{{margin:0;padding:0;box-sizing:border-box}}
    ...
    a{{color:#2C4F8F;text-decoration:underline;text-underline-offset:2px}}
...
<header>
  <div class="header-inner">
    ...
    <div class="header-meta">日本人投資家のためのマーケット情報サイト</div><div style="margin-top:11px;padding-top:11px;border-top:1px solid rgba(128,128,128,.22)"><div style="font-size:1.3rem;font-weight:700;color:#1E3A6E">📚 解説記事</div></div>
  </div>
</header>
<main>
  <nav class="nav-bar">
...
{watch_points_html}    </ol>
    ...
    <div class="info-box">
      <strong>発表前後はスプレッドが広がりやすい時間帯です。</strong>レバレッジを使ったFX取引は特に注意。発表直後の「初動」だけで飛びつかず、5〜10分後の「セカンド・リアクション」を確認するのがプロの基本。
    </div>
